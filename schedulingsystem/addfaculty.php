    ...
    <div class="col-lg-6">
		<div class="jumbotron">
				...
				<div class="form-group">
				  <label class="col-md-4 control-label" for="falname">Exam Name</label>  
				  <div class="col-md-5">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="subdays">Exam Day</label>  
				  <div class="col-md-5">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="subcolor">Exam color</label>  
				  <div class="col-md-5">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="subTime">Exam Time</label>  
				  <div class="col-md-5">
				...
				<div class="form-group"  align="right">
				  ...
				  <div class="col-md-5">
					<button id="submit" name="submit" class="btn btn-primary">Add Exam</button>
				  </div>
				</div>
