		...
		<form class="form-horizontal" method= "post" action = "add.cor.php">
			...
			<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="corcode">Course Color</label>  
				  <div class="col-md-5">
			...
			<!-- Text input-->
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="corstart">Start Date</label>  
				  <div class="col-md-5">
				  <input id="corstart" name="corstart" type="date" placeholder="" class="form-control input-md" required="">
				  </div>
				</div>

				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="corend">End Date</label>  
				  <div class="col-md-5">
				  <input id="corend" name="corend" type="date" placeholder="" class="form-control input-md" required="">
				  </div>
				</div>
